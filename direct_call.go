...
func lookupDirectCallBinding(key string) (DirectCallAdapter, bool) {
...
func resolveStaticDirectCall(fn *ssa.Function) (DirectCallAdapter, bool) {
	externalKey := fn.String()
	return lookupDirectCallBinding(externalKey)
}
