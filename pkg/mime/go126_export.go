...
func init() {
	ixgo.RegisterPackageLazy("mime", func() *ixgo.Package {
		return &ixgo.Package{
			Name: "mime",
			Path: "mime",
			...
			TypedConsts: map[string]ixgo.TypedConst{
				"BEncoding": {Typ: reflect.TypeOf(q.BEncoding), Value: constant.MakeInt64(int64(q.BEncoding))},
				"QEncoding": {Typ: reflect.TypeOf(q.QEncoding), Value: constant.MakeInt64(int64(q.QEncoding))},
			},
