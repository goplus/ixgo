...
func init() {
	ixgo.RegisterPackageLazy("net", func() *ixgo.Package {
		return &ixgo.Package{
			Name: "net",
			Path: "net",
			...
			TypedConsts: map[string]ixgo.TypedConst{
				"FlagBroadcast":    {Typ: reflect.TypeOf(q.FlagBroadcast), Value: constant.MakeInt64(int64(q.FlagBroadcast))},
				"FlagLoopback":     {Typ: reflect.TypeOf(q.FlagLoopback), Value: constant.MakeInt64(int64(q.FlagLoopback))},
				"FlagMulticast":    {Typ: reflect.TypeOf(q.FlagMulticast), Value: constant.MakeInt64(int64(q.FlagMulticast))},
				"FlagPointToPoint": {Typ: reflect.TypeOf(q.FlagPointToPoint), Value: constant.MakeInt64(int64(q.FlagPointToPoint))},
				"FlagRunning":      {Typ: reflect.TypeOf(q.FlagRunning), Value: constant.MakeInt64(int64(q.FlagRunning))},
				"FlagUp":           {Typ: reflect.TypeOf(q.FlagUp), Value: constant.MakeInt64(int64(q.FlagUp))},
			},
