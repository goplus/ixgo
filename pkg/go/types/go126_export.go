...
func init() {
	ixgo.RegisterPackage(&ixgo.Package{
		...
		TypedConsts: map[string]ixgo.TypedConst{
			...
			"FieldVar":       {reflect.TypeOf(q.FieldVar), constant.MakeInt64(int64(q.FieldVar))},
			...
			"LocalVar":       {reflect.TypeOf(q.LocalVar), constant.MakeInt64(int64(q.LocalVar))},
			...
			"PackageVar":     {reflect.TypeOf(q.PackageVar), constant.MakeInt64(int64(q.PackageVar))},
			"ParamVar":       {reflect.TypeOf(q.ParamVar), constant.MakeInt64(int64(q.ParamVar))},
			"RecvOnly":       {reflect.TypeOf(q.RecvOnly), constant.MakeInt64(int64(q.RecvOnly))},
			"RecvVar":        {reflect.TypeOf(q.RecvVar), constant.MakeInt64(int64(q.RecvVar))},
			"ResultVar":      {reflect.TypeOf(q.ResultVar), constant.MakeInt64(int64(q.ResultVar))},
