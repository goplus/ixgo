...
func init() {
	ixgo.RegisterPackageLazy("go/ast", func() *ixgo.Package {
		return &ixgo.Package{
			Name: "ast",
			Path: "go/ast",
			...
			NamedTypes: map[string]reflect.Type{
				...
				"DirectiveArg":   reflect.TypeOf((*q.DirectiveArg)(nil)).Elem(),
			...
			Funcs: map[string]reflect.Value{
				...
				"ParseDirective":    reflect.ValueOf(q.ParseDirective),
				"Preorder":          reflect.ValueOf(q.Preorder),
				"PreorderStack":     reflect.ValueOf(q.PreorderStack),
				"Print":             reflect.ValueOf(q.Print),
				"SortImports":       reflect.ValueOf(q.SortImports),
				"Unparen":           reflect.ValueOf(q.Unparen),
