...
func init() {
	ixgo.RegisterPackageLazy("go/build", func() *ixgo.Package {
		return &ixgo.Package{
			Name: "build",
			Path: "go/build",
			...
			TypedConsts: map[string]ixgo.TypedConst{
				"AllowBinary":   {Typ: reflect.TypeOf(q.AllowBinary), Value: constant.MakeInt64(int64(q.AllowBinary))},
				"FindOnly":      {Typ: reflect.TypeOf(q.FindOnly), Value: constant.MakeInt64(int64(q.FindOnly))},
				"IgnoreVendor":  {Typ: reflect.TypeOf(q.IgnoreVendor), Value: constant.MakeInt64(int64(q.IgnoreVendor))},
				"ImportComment": {Typ: reflect.TypeOf(q.ImportComment), Value: constant.MakeInt64(int64(q.ImportComment))},
			},
