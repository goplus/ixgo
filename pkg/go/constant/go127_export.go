...
func init() {
	ixgo.RegisterPackageLazy("go/constant", func() *ixgo.Package {
		return &ixgo.Package{
			Name: "constant",
			Path: "go/constant",
			...
			Funcs: map[string]reflect.Value{
				...
				"StringLen":       reflect.ValueOf(q.StringLen),
			...
			TypedConsts: map[string]ixgo.TypedConst{
				...
				"Complex": {Typ: reflect.TypeOf(q.Complex), Value: constant.MakeInt64(int64(q.Complex))},
				...
				"Unknown": {Typ: reflect.TypeOf(q.Unknown), Value: constant.MakeInt64(int64(q.Unknown))},
			},
