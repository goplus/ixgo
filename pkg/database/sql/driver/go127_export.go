...
func init() {
	ixgo.RegisterPackageLazy("database/sql/driver", func() *ixgo.Package {
		return &ixgo.Package{
			Name: "driver",
			...
			Interfaces: map[string]reflect.Type{
				...
				"RowsColumnScanner":              reflect.TypeOf((*q.RowsColumnScanner)(nil)).Elem(),
			...
			NamedTypes: map[string]reflect.Type{
				...
				"ScanContext":    reflect.TypeOf((*q.ScanContext)(nil)).Elem(),
