...
func init() {
	ixgo.RegisterPackageLazy("archive/zip", func() *ixgo.Package {
		return &ixgo.Package{
			Name: "zip",
			Path: "archive/zip",
			...
			TypedConsts: map[string]ixgo.TypedConst{
				"Deflate": {Typ: reflect.TypeOf(q.Deflate), Value: constant.MakeInt64(int64(q.Deflate))},
				"Store":   {Typ: reflect.TypeOf(q.Store), Value: constant.MakeInt64(int64(q.Store))},
			},
