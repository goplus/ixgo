...
func init() {
	ixgo.RegisterPackage(&ixgo.Package{
		...
		UntypedConsts: map[string]ixgo.UntypedConst{
			...
			"PTRACE_ARCH_PRCTL":                {"untyped int", constant.MakeInt64(int64(q.PTRACE_ARCH_PRCTL))},
			...
			"SYS_ARCH_PRCTL":                   {"untyped int", constant.MakeInt64(int64(q.SYS_ARCH_PRCTL))},
			...
			"SYS_EPOLL_CTL_OLD":                {"untyped int", constant.MakeInt64(int64(q.SYS_EPOLL_CTL_OLD))},
			...
			"SYS_EPOLL_WAIT_OLD":               {"untyped int", constant.MakeInt64(int64(q.SYS_EPOLL_WAIT_OLD))},
			...
			"SYS_SECURITY":                     {"untyped int", constant.MakeInt64(int64(q.SYS_SECURITY))},
