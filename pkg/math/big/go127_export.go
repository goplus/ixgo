...
func init() {
	ixgo.RegisterPackage(&ixgo.Package{
		...
		TypedConsts: map[string]ixgo.TypedConst{
			...
			"Ceil":          {Typ: reflect.TypeOf(q.Ceil), Value: constant.MakeInt64(int64(q.Ceil))},
			"Exact":         {Typ: reflect.TypeOf(q.Exact), Value: constant.MakeInt64(int64(q.Exact))},
			"Floor":         {Typ: reflect.TypeOf(q.Floor), Value: constant.MakeInt64(int64(q.Floor))},
			"Round":         {Typ: reflect.TypeOf(q.Round), Value: constant.MakeInt64(int64(q.Round))},
			...
			"Trunc":         {Typ: reflect.TypeOf(q.Trunc), Value: constant.MakeInt64(int64(q.Trunc))},
		},
