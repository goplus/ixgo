...
func init() {
	ixgo.RegisterPackage(&ixgo.Package{
		...
		TypedConsts: map[string]ixgo.TypedConst{
			...
			"MapCtrlEmpty":        {Typ: reflect.TypeOf(q.MapCtrlEmpty), Value: constant.MakeUint64(uint64(q.MapCtrlEmpty))},
		...
		UntypedConsts: map[string]ixgo.UntypedConst{
			"MapGroupSlots":           {Typ: "untyped int", Value: constant.MakeInt64(int64(q.MapGroupSlots))},
			"MapGroupSlotsBits":       {Typ: "untyped int", Value: constant.MakeInt64(int64(q.MapGroupSlotsBits))},
			"MapHashMightPanic":       {Typ: "untyped int", Value: constant.MakeInt64(int64(q.MapHashMightPanic))},
			"MapIndirectElem":         {Typ: "untyped int", Value: constant.MakeInt64(int64(q.MapIndirectElem))},
			"MapIndirectKey":          {Typ: "untyped int", Value: constant.MakeInt64(int64(q.MapIndirectKey))},
			"MapMaxElemBytes":         {Typ: "untyped int", Value: constant.MakeInt64(int64(q.MapMaxElemBytes))},
			"MapMaxKeyBytes":          {Typ: "untyped int", Value: constant.MakeInt64(int64(q.MapMaxKeyBytes))},
			"MapNeedKeyUpdate":        {Typ: "untyped int", Value: constant.MakeInt64(int64(q.MapNeedKeyUpdate))},
