...
func init() {
	ixgo.RegisterPackage(&ixgo.Package{
		...
		TypedConsts: map[string]ixgo.TypedConst{
			...
			"ImplicitFun":                {reflect.TypeOf(q.ImplicitFun), constant.MakeInt64(int64(q.ImplicitFun))},
			"ImplicitPkg":                {reflect.TypeOf(q.ImplicitPkg), constant.MakeInt64(int64(q.ImplicitPkg))},
