...
func init() {
	ixgo.RegisterPackage("github.com/goplus/xgo/ast", func() *ixgo.Package {
		return &ixgo.Package{
			Name: "ast",
			...
			Funcs: map[string]interface{}{
				...
				"NewIdent":          q.NewIdent,
				"NewIdentEx":        q.NewIdentEx,
				"NewObj":            q.NewObj,
				"NewScope":          q.NewScope,
				"NextPartPos":       q.NextPartPos,
			...
			TypedConsts: map[string]interface{}{
				...
				"Fun":                        q.Fun,
				"ImplicitFun":                q.ImplicitFun,
				"ImplicitPkg":                q.ImplicitPkg,
				"Lbl":                        q.Lbl,
				"Pkg":                        q.Pkg,
				"RECV":                       q.RECV,
				"SEND":                       q.SEND,
