...
func init() {
	ixgo.RegisterPackageLazy("github.com/goplus/xgo/ast", func() *ixgo.Package {
		return &ixgo.Package{
			Name: "ast",
			Path: "github.com/goplus/xgo/ast",
			...
			NamedTypes: map[string]reflect.Type{
				...
				"DomainTextLitEx":   reflect.TypeOf((*q.DomainTextLitEx)(nil)).Elem(),
			...
			Funcs: map[string]reflect.Value{
				...
				"NewIdentEx":        reflect.ValueOf(q.NewIdentEx),
			...
			TypedConsts: map[string]ixgo.TypedConst{
				"Bad":                        {Typ: reflect.TypeOf(q.Bad), Value: constant.MakeInt64(int64(q.Bad))},
				"Con":                        {Typ: reflect.TypeOf(q.Con), Value: constant.MakeInt64(int64(q.Con))},
				"FilterFuncDuplicates":       {Typ: reflect.TypeOf(q.FilterFuncDuplicates), Value: constant.MakeInt64(int64(q.FilterFuncDuplicates))},
				"FilterImportDuplicates":     {Typ: reflect.TypeOf(q.FilterImportDuplicates), Value: constant.MakeInt64(int64(q.FilterImportDuplicates))},
				"FilterUnassociatedComments": {Typ: reflect.TypeOf(q.FilterUnassociatedComments), Value: constant.MakeInt64(int64(q.FilterUnassociatedComments))},
				"Fun":                        {Typ: reflect.TypeOf(q.Fun), Value: constant.MakeInt64(int64(q.Fun))},
				"ImplicitFun":                {Typ: reflect.TypeOf(q.ImplicitFun), Value: constant.MakeInt64(int64(q.ImplicitFun))},
				"ImplicitPkg":                {Typ: reflect.TypeOf(q.ImplicitPkg), Value: constant.MakeInt64(int64(q.ImplicitPkg))},
				"Lbl":                        {Typ: reflect.TypeOf(q.Lbl), Value: constant.MakeInt64(int64(q.Lbl))},
				"Pkg":                        {Typ: reflect.TypeOf(q.Pkg), Value: constant.MakeInt64(int64(q.Pkg))},
				"RECV":                       {Typ: reflect.TypeOf(q.RECV), Value: constant.MakeInt64(int64(q.RECV))},
				"SEND":                       {Typ: reflect.TypeOf(q.SEND), Value: constant.MakeInt64(int64(q.SEND))},
				"Typ":                        {Typ: reflect.TypeOf(q.Typ), Value: constant.MakeInt64(int64(q.Typ))},
