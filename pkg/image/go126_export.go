...
func init() {
	ixgo.RegisterPackageLazy("image", func() *ixgo.Package {
		return &ixgo.Package{
			Name: "image",
			Path: "image",
			...
			TypedConsts: map[string]ixgo.TypedConst{
				"YCbCrSubsampleRatio410": {Typ: reflect.TypeOf(q.YCbCrSubsampleRatio410), Value: constant.MakeInt64(int64(q.YCbCrSubsampleRatio410))},
				"YCbCrSubsampleRatio411": {Typ: reflect.TypeOf(q.YCbCrSubsampleRatio411), Value: constant.MakeInt64(int64(q.YCbCrSubsampleRatio411))},
				"YCbCrSubsampleRatio420": {Typ: reflect.TypeOf(q.YCbCrSubsampleRatio420), Value: constant.MakeInt64(int64(q.YCbCrSubsampleRatio420))},
				"YCbCrSubsampleRatio422": {Typ: reflect.TypeOf(q.YCbCrSubsampleRatio422), Value: constant.MakeInt64(int64(q.YCbCrSubsampleRatio422))},
				"YCbCrSubsampleRatio440": {Typ: reflect.TypeOf(q.YCbCrSubsampleRatio440), Value: constant.MakeInt64(int64(q.YCbCrSubsampleRatio440))},
				"YCbCrSubsampleRatio444": {Typ: reflect.TypeOf(q.YCbCrSubsampleRatio444), Value: constant.MakeInt64(int64(q.YCbCrSubsampleRatio444))},
			},
