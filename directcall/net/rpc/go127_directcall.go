...
func method_ptr_Client_Call(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.Client).Call(ixgo.DirectCallArg[*q.Client](ctx, 0), ixgo.DirectCallArg[string](ctx, 1), ixgo.DirectCallArg[interface{}](ctx, 2), ixgo.DirectCallArg[interface{}](ctx, 3)))
}
...
func method_ptr_Client_Go(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.Client).Go(ixgo.DirectCallArg[*q.Client](ctx, 0), ixgo.DirectCallArg[string](ctx, 1), ixgo.DirectCallArg[interface{}](ctx, 2), ixgo.DirectCallArg[interface{}](ctx, 3), ixgo.DirectCallArg[chan *q.Call](ctx, 4)))
}
...
func func_Register(ctx ixgo.DirectCallContext) {
	ctx.SetResult(q.Register(ixgo.DirectCallArg[interface{}](ctx, 0)))
}

func func_RegisterName(ctx ixgo.DirectCallContext) {
	ctx.SetResult(q.RegisterName(ixgo.DirectCallArg[string](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1)))
}
...
func method_ptr_Server_Register(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.Server).Register(ixgo.DirectCallArg[*q.Server](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1)))
}

func method_ptr_Server_RegisterName(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.Server).RegisterName(ixgo.DirectCallArg[*q.Server](ctx, 0), ixgo.DirectCallArg[string](ctx, 1), ixgo.DirectCallArg[interface{}](ctx, 2)))
}
