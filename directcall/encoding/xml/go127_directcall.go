...
func method_ptr_Decoder_DecodeElement(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.Decoder).DecodeElement(ixgo.DirectCallArg[*q.Decoder](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1), ixgo.DirectCallArg[*q.StartElement](ctx, 2)))
}
...
func method_ptr_Encoder_EncodeElement(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.Encoder).EncodeElement(ixgo.DirectCallArg[*q.Encoder](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1), ixgo.DirectCallArg[q.StartElement](ctx, 2)))
}
