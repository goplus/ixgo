...
func method_ptr_List_InsertAfter(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.List).InsertAfter(ixgo.DirectCallArg[*q.List](ctx, 0), ixgo.DirectCallArg[any](ctx, 1), ixgo.DirectCallArg[*q.Element](ctx, 2)))
}

func method_ptr_List_InsertBefore(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.List).InsertBefore(ixgo.DirectCallArg[*q.List](ctx, 0), ixgo.DirectCallArg[any](ctx, 1), ixgo.DirectCallArg[*q.Element](ctx, 2)))
}
...
func method_ptr_List_PushBack(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.List).PushBack(ixgo.DirectCallArg[*q.List](ctx, 0), ixgo.DirectCallArg[any](ctx, 1)))
}
...
func method_ptr_List_PushFront(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.List).PushFront(ixgo.DirectCallArg[*q.List](ctx, 0), ixgo.DirectCallArg[any](ctx, 1)))
}
