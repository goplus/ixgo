...
func init() {
	ixgo.RegisterDirectCalls("database/sql", map[string]ixgo.DirectCallAdapter{
		...
		"ConvertAssign":                  func_ConvertAssign,
...
func func_ConvertAssign(ctx ixgo.DirectCallContext) {
	ctx.SetResult(q.ConvertAssign(ixgo.DirectCallArg[driver.ScanContext](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1), ixgo.DirectCallArg[driver.Value](ctx, 2)))
}
...
func func_Named(ctx ixgo.DirectCallContext) {
	ctx.SetResult(q.Named(ixgo.DirectCallArg[string](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1)))
}

func method_ptr_NullBool_Scan(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.NullBool).Scan(ixgo.DirectCallArg[*q.NullBool](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1)))
}

func method_ptr_NullByte_Scan(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.NullByte).Scan(ixgo.DirectCallArg[*q.NullByte](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1)))
}

func method_ptr_NullFloat64_Scan(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.NullFloat64).Scan(ixgo.DirectCallArg[*q.NullFloat64](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1)))
}

func method_ptr_NullInt16_Scan(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.NullInt16).Scan(ixgo.DirectCallArg[*q.NullInt16](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1)))
}

func method_ptr_NullInt32_Scan(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.NullInt32).Scan(ixgo.DirectCallArg[*q.NullInt32](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1)))
}

func method_ptr_NullInt64_Scan(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.NullInt64).Scan(ixgo.DirectCallArg[*q.NullInt64](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1)))
}

func method_ptr_NullString_Scan(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.NullString).Scan(ixgo.DirectCallArg[*q.NullString](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1)))
}

func method_ptr_NullTime_Scan(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.NullTime).Scan(ixgo.DirectCallArg[*q.NullTime](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1)))
}
