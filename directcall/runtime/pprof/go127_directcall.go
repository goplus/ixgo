...
func method_ptr_Profile_Add(ctx ixgo.DirectCallContext) {
	(*q.Profile).Add(ixgo.DirectCallArg[*q.Profile](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1), ixgo.DirectCallArg[int](ctx, 2))
}
...
func method_ptr_Profile_Remove(ctx ixgo.DirectCallContext) {
	(*q.Profile).Remove(ixgo.DirectCallArg[*q.Profile](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1))
}
