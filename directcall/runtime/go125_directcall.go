...
func func_KeepAlive(ctx ixgo.DirectCallContext) {
	q.KeepAlive(ixgo.DirectCallArg[any](ctx, 0))
}
...
func method_ptr_Pinner_Pin(ctx ixgo.DirectCallContext) {
	(*q.Pinner).Pin(ixgo.DirectCallArg[*q.Pinner](ctx, 0), ixgo.DirectCallArg[any](ctx, 1))
}
...
func func_SetFinalizer(ctx ixgo.DirectCallContext) {
	q.SetFinalizer(ixgo.DirectCallArg[any](ctx, 0), ixgo.DirectCallArg[any](ctx, 1))
}
