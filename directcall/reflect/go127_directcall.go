...
func func_DeepEqual(ctx ixgo.DirectCallContext) {
	ctx.SetResult(q.DeepEqual(ixgo.DirectCallArg[interface{}](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1)))
}
...
func func_Swapper(ctx ixgo.DirectCallContext) {
	ctx.SetResult(q.Swapper(ixgo.DirectCallArg[interface{}](ctx, 0)))
}

func func_TypeOf(ctx ixgo.DirectCallContext) {
	ctx.SetResult(q.TypeOf(ixgo.DirectCallArg[interface{}](ctx, 0)))
}
...
func func_ValueOf(ctx ixgo.DirectCallContext) {
	ctx.SetResult(q.ValueOf(ixgo.DirectCallArg[interface{}](ctx, 0)))
}
