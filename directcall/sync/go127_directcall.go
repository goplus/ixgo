...
func method_ptr_Map_CompareAndDelete(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.Map).CompareAndDelete(ixgo.DirectCallArg[*q.Map](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1), ixgo.DirectCallArg[interface{}](ctx, 2)))
}

func method_ptr_Map_CompareAndSwap(ctx ixgo.DirectCallContext) {
	ctx.SetResult((*q.Map).CompareAndSwap(ixgo.DirectCallArg[*q.Map](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1), ixgo.DirectCallArg[interface{}](ctx, 2), ixgo.DirectCallArg[interface{}](ctx, 3)))
}

func method_ptr_Map_Delete(ctx ixgo.DirectCallContext) {
	(*q.Map).Delete(ixgo.DirectCallArg[*q.Map](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1))
}
...
func method_ptr_Map_Store(ctx ixgo.DirectCallContext) {
	(*q.Map).Store(ixgo.DirectCallArg[*q.Map](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1), ixgo.DirectCallArg[interface{}](ctx, 2))
}
...
func method_ptr_Pool_Put(ctx ixgo.DirectCallContext) {
	(*q.Pool).Put(ixgo.DirectCallArg[*q.Pool](ctx, 0), ixgo.DirectCallArg[interface{}](ctx, 1))
}
