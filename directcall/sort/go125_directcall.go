...
func func_Slice(ctx ixgo.DirectCallContext) {
	q.Slice(ixgo.DirectCallArg[any](ctx, 0), ixgo.DirectCallArg[func(i int, j int) bool](ctx, 1))
}

func func_SliceIsSorted(ctx ixgo.DirectCallContext) {
	ctx.SetResult(q.SliceIsSorted(ixgo.DirectCallArg[any](ctx, 0), ixgo.DirectCallArg[func(i int, j int) bool](ctx, 1)))
}

func func_SliceStable(ctx ixgo.DirectCallContext) {
	q.SliceStable(ixgo.DirectCallArg[any](ctx, 0), ixgo.DirectCallArg[func(i int, j int) bool](ctx, 1))
}
