...
func func_Make(ctx ixgo.DirectCallContext) {
	ctx.SetResult(q.Make(ixgo.DirectCallArg[interface{}](ctx, 0)))
}
...
func func_StringLen(ctx ixgo.DirectCallContext) {
	ctx.SetResult(q.StringLen(ixgo.DirectCallArg[q.Value](ctx, 0)))
}
